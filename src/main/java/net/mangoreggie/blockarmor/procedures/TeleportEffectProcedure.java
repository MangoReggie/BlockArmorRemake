...
public class TeleportEffectProcedure {
	...
	public static void execute(LevelAccessor world, Entity entity) {
		...
		double armorCount = 0;
		if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).is(TagKey.create(Registries.ITEM, ResourceLocation.parse("minecraft:chorus_armor")))) {
			armorCount = armorCount + 1;
		}
		if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.CHEST) : ItemStack.EMPTY).is(TagKey.create(Registries.ITEM, ResourceLocation.parse("minecraft:chorus_armor")))) {
			armorCount = armorCount + 1;
		}
		if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.LEGS) : ItemStack.EMPTY).is(TagKey.create(Registries.ITEM, ResourceLocation.parse("minecraft:chorus_armor")))) {
			armorCount = armorCount + 1;
		}
		if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).is(TagKey.create(Registries.ITEM, ResourceLocation.parse("minecraft:chorus_armor")))) {
			armorCount = armorCount + 1;
		}
		if (armorCount >= 2) {
