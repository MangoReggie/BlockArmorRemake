...
import net.mangoreggie.blockarmor.init.BlockArmorModTabs;
...
@Mod("block_armor")
public class BlockArmorMod {
	public static final Logger LOGGER = LogManager.getLogger(BlockArmorMod.class);
	public static final String MODID = "block_armor";

	public BlockArmorMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		BlockArmorModBlocks.REGISTRY.register(modEventBus);
		BlockArmorModItems.REGISTRY.register(modEventBus);
		BlockArmorModTabs.REGISTRY.register(modEventBus);
		BlockArmorModVariables.ATTACHMENT_TYPES.register(modEventBus);
