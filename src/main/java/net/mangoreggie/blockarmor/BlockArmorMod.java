...
import net.mangoreggie.blockarmor.init.*;
...
public class BlockArmorMod implements ModInitializer {
	...
	public void onInitialize() {
		...
		LOGGER.info("Initializing BlockArmorMod");
		BlockArmorModTabs.load();
		BlockArmorModVariables.variablesLoad();
		BlockArmorModBlocks.load();
		BlockArmorModItems.load();
		BlockArmorModCommands.load();
		BlockArmorModProcedures.load();
		BlockArmorModKeyMappingsServer.serverLoad();
		tick();
