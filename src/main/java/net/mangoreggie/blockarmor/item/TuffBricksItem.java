...
public abstract class TuffBricksItem extends Item {
	public static ArmorMaterial ARMOR_MATERIAL = new ArmorMaterial(45, Map.of(ArmorType.BOOTS, 2, ArmorType.LEGGINGS, 6, ArmorType.CHESTPLATE, 7, ArmorType.HELMET, 2, ArmorType.BODY, 7), 12,
			BuiltInRegistries.SOUND_EVENT.wrapAsHolder(BuiltInRegistries.SOUND_EVENT.getValue(ResourceLocation.parse("item.armor.equip_generic"))), 0.5f, 0.01f,
			TagKey.create(Registries.ITEM, ResourceLocation.parse("block_armor:tuff_bricks_repair_items")), ResourceKey.create(EquipmentAssets.ROOT_ID, ResourceLocation.parse("block_armor:tuff_bricks")));
